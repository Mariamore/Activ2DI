...
import controlador.GestorEventosAgregar;
...
public class VentanaAgregar extends JDialog{
	...
	private GestorEventosAgregar gestor;
	...
	public VentanaAgregar() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/imagenes/agregar-contacto.png"));
		setLayout(null);
	...
	public void establecerGestor(GestorEventosAgregar gestor) {
		this.gestor = gestor;
